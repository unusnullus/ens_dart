...
class EnsReverseRegistrar extends _i1.GeneratedContract {
  ...
  Future<_i3.Uint8List> aDDRkREVERSEkNODE({_i1.BlockNum? atBlock}) async {
  ...
  /// set by the contract.
  Future<String> claim(_i2.EthereumAddress owner,
  ...
  Future<String> claimWithResolver(
      _i2.EthereumAddress owner, _i2.EthereumAddress resolver,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<_i2.EthereumAddress> defaultResolver({_i1.BlockNum? atBlock}) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<_i3.Uint8List> node(_i2.EthereumAddress addr,
