...
class ENSRoot extends _i1.GeneratedContract {
  ...
  Future<bool> controllers(_i2.EthereumAddress $param0,
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<_i2.EthereumAddress> ens({_i1.BlockNum? atBlock}) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<bool> isOwner(_i2.EthereumAddress addr,
      {_i1.BlockNum? atBlock}) async {
  ...
  /// set by the contract.
  Future<String> lock(_i3.Uint8List label,
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<bool> locked(_i3.Uint8List $param3, {_i1.BlockNum? atBlock}) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> setController(_i2.EthereumAddress controller, bool enabled,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> setResolver(_i2.EthereumAddress resolver,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> setSubnodeOwner(_i3.Uint8List label, _i2.EthereumAddress owner,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
...
class TLDLocked {
  TLDLocked(List<dynamic> response) : label = (response[0] as _i3.Uint8List);
